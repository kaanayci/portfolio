      ...
      <div class="flex items-center justify-between mt-2 max-w-[150px]">
        <div class="flex items-center border rounded-md bg-white shadow-sm">
          <button 
            ...
            :aria-label="item.quantity === 1 ? 'Supprimer ' + item.product.name : 'Diminuer la quantité'"
          >
            <svg v-if="item.quantity === 1" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
