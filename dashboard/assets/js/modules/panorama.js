function loadPanorama() {
    ...
    cities.forEach(city => {
        ...
        .done(data => {
            ...
            const card = `
                <div class="city-card animate-pop" onclick="localStorage.setItem('lastCity', '${city}'); localStorage.removeItem('lastCityName'); localStorage.setItem('forceWeather','1'); $('.sidebar li[data-channel=meteo]').click();">
                    <h3>${city}</h3>
                    <div class="city-temp">
                        ${temp}° 
